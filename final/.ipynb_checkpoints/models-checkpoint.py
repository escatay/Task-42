    ...
    def update(self, bf):
        ...
        if self.bf == "polynomial":
            ...
            self.fig.update_layout(
                ...
                annotations=[
                    dict(text=r'$$\phi(x) = \begin{bmatrix} 1 & x & x^2 & \cdots & x^d \end{bmatrix} = \begin{bmatrix} x^0 & x^1 & x^2 & \cdots & x^d \end{bmatrix} = \begin{bmatrix} x^j \end{bmatrix}_{j=0}^d$$', showarrow= False, font=dict(size=18),
